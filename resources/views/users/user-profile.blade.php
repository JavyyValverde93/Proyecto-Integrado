<x-app-layout>
    ...
    <style>
        ...
        img:hover, .card:hover, .card-title:hover{
            transform: scale(1.1)
        }
...
.profile-card__img {
  ...
  position: relative;
  z-index: 4;
  box-shadow: 0px 5px 50px 0px #44fc91, 0px 0px 0px 7px rgba(32, 197, 37, 0.5);
}
                        ...
                        <div class="profile-card js-profile-card">
                          ...
                          <div class="profile-card__cnt js-profile-cnt">
                            ...
                            <div class="profile-card-ctr">
                                <button class="profile-card__button button--blue js-message-btn">Contacto</button>
                                <button class="profile-card__button button--orange"><i class="fas fa-plus"></i> Seguir</button>
                              </div>

                <div class="row" style="border-top: 1px solid rgb(211, 209, 209); border-bottom: 1px solid rgb(211, 209, 209)">
                    <?php $num=2; ?>
                    @foreach($productos as $item)
                    <div class="col-md-5 mx-auto my-3">
                        <a href="{{route('productos.show', $item)}}" style="text-decoration: none; color: black">
                            <div @if($num%2==0) class="card float-right" @else class="card float-left" @endif style="width: 18rem;">
                                <div class="cardimg">
                                    <img class="card-img-top" src="{{asset($item->foto1)}}" alt="Card image cap">
                                </div>
...
{{--
                    ...
                    <div class="col-md-5 my-3">
                        <a href="{{route('productos.show', $item->producto)}}" style="text-decoration: none; color: black">
                            <div class="card" style="width: 18rem;">
                                <div class="cardimg">
                                    <img class="card-img-top" src="{{asset($item->producto->foto1)}}" alt="Card image cap">
                                </div>
                                <div class="card-body">
                                <h5 class="card-title">{{$item->producto->nombre}}</h5>
                                <h4 class="card-title">{{$item->producto->precio}} €</h4>
                                <h6 class="card-title font-italic">{{$item->producto->categoria}}</h6>
