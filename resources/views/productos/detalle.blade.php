                ...
                <div class="m-1 p-3 rounded row"
                    ...
                    <div class="col-2 my-auto">
                        ...
                        <div id="reemplazar">
                            ...
                            <form action="{{route('guardados.destroy', $save)}}" id="quitaFav"
                                onsubmit="submitForm2(event)" method="POST" name="delete_prod">
                                @csrf
                                <button type="submit"></button>
                            </form>
                            @endforeach
                    ...
                    <script type="text/javascript">
                        ...
                        function submitForm2(event) {
                            $.ajax({
                                type: $('#quitaFav').attr('method'),
                                url: $('#quitaFav').attr('action'),
                                data: $('#quitaFav').serialize(),
                                success: function (data) {
                                    console.log('Datos enviados !!!');
                                }
                            });
                        ...
                        //Comentarios
                        function submitComent(event) {
                            $.ajax({
                                type: $('#submitComent').attr('method'),
                                url: $('#submitComent').attr('action'),
                                data: $('#submitComent').serialize(),
                                success: function (data) {
                                    console.log('Datos enviados !!!');
                                }
                            });
                    ...
                    <div class="mb-5 mx-5 p-2 mt-5" style="font-size:1.5em; background: rgba(214, 212, 212, 0.097)">
                        <div id="actualisa">
                            <b>{{$producto->nombre}}</b><i class="float-right mx-3"><i class="far fa-eye"></i>
                                {{$producto->visualizaciones}}<i class="far fa-bookmark ml-3"></i> {{$favoritos}}</i>
                            <br>
                        ...
                        <div class="row justify-center">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" style="max-width: 400px;"
                                    ...
                                    <div style="width: 440px; max-width: 400px; max-height:400px; overflow-y:scroll">
                                        <div id="comentAct">
                                            ...
                                            <div class="p-3 rounded mt-2"
                                                ...
                                                <form action="{{route('comentarios.destroy', $coments)}}" id="delComent"
                                                ...
                                                <form
                                                    ...
                                                    <input value="{{ old('respuesta') }}" required type="text"
                                                        name="respuesta" required minlength="2" maxlength="150"
                                                        placeholder="Respuesta comentario...">
                                    ...
                                    <div id="comentAct2">
                                        <form action="{{route('comentarios.store')}}" id="submitComent" class="my-4"
                                            method="POST" name="com" onsubmit="disableButton(this); submitComent(event);">
                                            @csrf
                                            ...
                                            <textarea cols="40" maxlength="150" style="width: 100%" name="comentario"
                                ...
                                <div class="tab-pane fade" id="nav-profile" style="max-width: 400px" role="tabpanel"
                                    ...
                                    <div id="pregAct2">
                                        ...
                                        @endif
                                        <form action="{{route('preguntas.store')}}" id="submitPreg" method="POST"
                                            onsubmit="disableButton(this); submitPreg(event)">
                                            @csrf
                                            @if(Auth::user()!=null)
                    ...
                    <div class="modal-body"
                        ...
                        <form
                            ...
                            <div class="form-group" align="center">
                                ...
                                <label class="font-bold p-1 rounded" style="background-color: rgb(255, 255, 255)">¿Qué
                                    le
