        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="row">
                ...
                <form action="{{route('productos.index')}}" class="col-md-auto col-xs-4 mt-2" method="GET">
                    ...
                    <input class="formIndex p-2 rounded" list="ciudades" placeholder="Buscar en..."
                    ...
                    <div class="container-fluid">
                        <div class="" align="right">
                            <form action="{{route('productos.index')}}" method="GET">
                                <select name="categoria" class="form-control fa rounded my-4"
                                    onchange="this.form.submit()">
                                    <option value="">Seleccione la categoría...</option>
                                    <option class="fa" value="Coches" @if($request->categoria!=null &&
                                        $request->categoria=="Coches") selected @endif>&#xf1b9; Coches</option>
                                    <option class="fa" value="Motos" @if($request->categoria!=null &&
                                        $request->categoria=="Motos") selected @endif>&#xf21c; Motos</option>
                                    <option class="fa" value="Motor y Accesorios" @if($request->categoria!=null &&
                                        $request->categoria=="Motor y Accesorios") selected @endif>&#xf5e3; Motor y
                                        Accesorios</option>
                                    <option class="fa" value="Inmobiliaria" @if($request->categoria!=null &&
                                        $request->categoria=="Inmobiliaria") selected @endif>&#xf015; Inmobiliaria
                                    </option>
                                    <option class="fa" value="Tv, Audio y Foto" @if($request->categoria!=null &&
                                        $request->categoria=="Tv, Audio y Foto") selected @endif>&#xf26c; Tv, Audio y
                                        Foto</option>
                                    <option class="fa" value="Móviles y Telefonía" @if($request->categoria!=null &&
                                        $request->categoria=="Móviles y Telefonía") selected @endif>&#xf10b; Móviles y
                                        Telefonía</option>
                                    <option class="fa" value="Informática y Electrónica" @if($request->categoria!=null
                                        && $request->categoria=="Informática y Electrónica") selected @endif>&#xf109;
                                        Informática y Electrónica</option>
                                    <option class="fa" value="Deporte y Ocio" @if($request->categoria!=null &&
                                        $request->categoria=="Deporte y Ocio") selected @endif>&#xf45f; Deporte y Ocio
                                    </option>
                                    <option class="fa" value="Bicicletas" @if($request->categoria!=null &&
                                        $request->categoria=="Bicicletas") selected @endif>&#xf84a; Bicicletas</option>
                                    <option class="fa" value="Consolas y Videojuegos" @if($request->categoria!=null &&
                                        $request->categoria=="Consolas y Videojuegos") selected @endif>&#xf11b; Consolas
                                        y Videojuegos</option>
                                    <option class="fa" value="Hogar y Jardín" @if($request->categoria!=null &&
                                        $request->categoria=="Hogar y Jardín") selected @endif>&#xf801; Hogar y Jardín
                                    </option>
                                    <option class="fa" value="Electrodomésticos" @if($request->categoria!=null &&
                                        $request->categoria=="Electrodomésticos") selected @endif>&#xf898;
                                        Electrodomésticos</option>
                                    <option class="fa" value="Cine, Libros y Música" @if($request->categoria!=null &&
                                        $request->categoria=="Cine, Libros y Música") selected @endif>&#xf008; Cine,
                                        Libros y Música</option>
                                    <option class="fa" value="Niños y Bebés" @if($request->categoria!=null &&
                                        $request->categoria=="Niños y Bebés") selected @endif>&#xf77c; Niños y Bebés
                                    </option>
                                    <option class="fa" value="Coleccionismo" @if($request->categoria!=null &&
                                        $request->categoria=="Coleccionismo") selected @endif>&#xf70f; Coleccionismo
                                    </option>
                                    <option class="fa" value="Materiales de construcción" @if($request->categoria!=null
                                        && $request->categoria=="Materiales de construcción") selected @endif>&#xf6e3;
                                        Materiales de construcción</option>
                                    <option class="fa" value="Industria y Agricultura" @if($request->categoria!=null &&
                                        $request->categoria=="Industria y Agricultura") selected @endif>&#xf722;
                                        Industria y Agricultura</option>
                                    <option class="fa" value="Empleo" @if($request->categoria!=null &&
                                        $request->categoria=="Empleo") selected @endif>&#xf0b1; Empleo</option>
                                    <option class="fa" value="Servicios" @if($request->categoria!=null &&
                                        $request->categoria=="Servicios") selected @endif>&#xf554; Servicios</option>
                                    <option class="fa" value="Otros" @if($request->categoria!=null &&
                                        $request->categoria=="Otros") selected @endif>&#xf069; Otros</option>
                                </select>
                                ...
                                <div class="card" style="width: 18rem;">
                                    <a href="{{route('productos.show', [$item, 'u=%'])}}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <label class="float-right" align="right"
                                                style="opacity: 50%">{{$item->created_at}}</label>
                                        </div>
                                    </a>
